...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/Navbar-Right-Links-Dark.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/Projects-Grid-Horizontal.css') }}">
...
<body>
    <nav class="navbar navbar-dark navbar-expand-md bg-dark py-3">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="#">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bezier">
                    ...
                    <span><img src="{{asset('images/logo/logo.png')}}" alt="Your Store" width="40" height="40" title="Your Store"></span>
                    <span>&nbsp;DoICT&nbsp;TRAINING DATABASE PLATFORM</span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-5"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
    ...
    <div class="carousel slide" data-bs-ride="carousel" id="carousel-1" style="height: 600px;">
        <div class="carousel-inner h-100">
            <div class="carousel-item active h-100"><img class="w-100 d-block position-absolute h-100 fit-cover" src="{{asset('images/w1.jpeg')}}" alt="Slide Image" style="z-index: -1;">
                <div class="container d-flex flex-column justify-content-center h-100">
                    <div class="row d-xxl-flex justify-content-xxl-center align-items-xxl-center h-100">
                        <div class="col-md-6 text-center text-md-start d-flex d-sm-flex d-md-flex justify-content-center align-items-center justify-content-md-start align-items-md-center justify-content-xl-center">
                            <div style="max-width: 350px;">
                                <h1 class="text-uppercase fw-bold" style="font-size: 35px;width: 422px;text-align: center;color: var(--bs-blue);">DoICT&nbsp;TRAINING DATABASE PLATFORM<br></h1>
                                <a class="btn btn-outline-primary btn-lg" role="button" href="#" style="padding-left: 22px;margin-left: 149px;">Join Our Team</a>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="carousel-item h-100"><img class="w-100 d-block position-absolute h-100 fit-cover" src="{{asset('images/w1.jpeg')}}" alt="Slide Image" style="z-index: -1;">
                <div class="container d-flex flex-column justify-content-center h-100">
                    <div class="row">
